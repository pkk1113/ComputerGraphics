...
//////////////////////////////////////////////////////////////////////////
static AppBase* g_pApplication = nullptr;
...
//////////////////////////////////////////////////////////////////////////
bool windows_base::InitPlatformSettings(const char* title, int width, int height)
{
	// Regist window class
...
bool windows_base::ReleasePlatformSettings()
{
	if (g_hinstance == NULL)
	{
		return false;
...
bool windows_base::RunApp(AppBase* app)
{
	// æ€ √ ±‚»≠
	g_pApplication = app;
